        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                    ...
                    <!--begin::Add customer-->
                    <a  href="{{ route('dashboard.agents.create') }}" class="btn btn-primary" >
            ...
            <table class="table text-center align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                ...
                @foreach($agents as $agent)
                    ...
                    <tr>
                        <!--begin::Name=-->
                        <td>
                            <a href="../../demo1/dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">{{ $agent->name }}</a>
                        </td>
                        <!--end::Name=-->
                        <!--begin::Email=-->
                        <td>
                            <a href="#" class="text-gray-600 text-hover-primary mb-1">{{ $agent->email }}</a>
                        </td>
                        <!--end::Email=-->
                        <!--begin::Payment method=-->
                        <td>
                            <img src=asset('dashboard-assets/media/svg/card-logos/mastercard.svg') class="w-35px me-3" alt="" />{{ $agent->phone }}</td>
                        <!--end::Payment method=-->
                        <!--begin::Date=-->
                        ...
                        <td>
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{ route('dashboard.agents.show',$agent) }}" class="menu-link px-3">View</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{ route('dashboard.agents.edit',$agent) }}" class="menu-link px-3">Edit</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
