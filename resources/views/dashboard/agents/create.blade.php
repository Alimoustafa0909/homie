...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.agents.store') }}" class="form" method="post"  enctype="multipart/form-data">
            @csrf
            <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark"> Add Agent</h3>
                </div>
                <!-- end   :: Card header -->
                ...
                <div class="px-8 py-4">
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="title_inp" name="title" placeholder="example" value="{{ old('title') }}">
                                <label for="phone_inp">Title</label>
                            </div>
                            @error('title')
                            <p class="text-danger">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <textarea name="biography"  class="form-control"  placeholder="Message"></textarea>
                            </div>
                            @error('biography')
                            <p class="text-danger">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <textarea name="work_experience"   class="form-control"  placeholder="Message"></textarea>
                            </div>
