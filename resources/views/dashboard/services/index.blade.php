            ...
            <table class="table text-center align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                ...
                @foreach($services as $service)
                    ...
                    <tr>
                        <!--begin::Name=-->
                        <td>
                            <a href="../../demo1/dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">{{ $service->name }}</a>
                        </td>
                        <!--end::Name=-->

                        <!--begin::Payment method=-->
                        <td>
                            <img src=asset('dashboard-assets/media/svg/card-logos/mastercard.svg') class="w-35px me-3" alt="" />{{ $service->description }}</td>
                        <!--end::Payment method=-->
                        <!--begin::Date=-->
                        ...
                        <td>
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{ route('dashboard.services.show',$service) }}" class="menu-link px-3">View</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{ route('dashboard.services.edit',$service) }}" class="menu-link px-3">Edit</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
