        ...
        <div class="card-body p-0">
            ...
            <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark"> Service Details</h3>
                </div>
                <!-- end   :: Card header -->
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-12 text-center mb-5 fv-row">
                            ...
                            <div class="image-input image-input-empty"
                                 style="background-image: url('{{ asset('storage/images/services/' . $service['image']) }}')">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" disabled class="form-control"  value="{{ $service->description }}" />
                ...
                <div class="form-footer p-8 text-end">
                    ...
                    <!-- begin :: Submit btn -->
                    <a class="btn btn-primary" href="{{ route('dashboard.services.index') }}">
                        Back
                    </a>
                    <!-- end   :: Submit btn -->
