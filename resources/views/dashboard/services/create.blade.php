...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.services.store') }}" class="form" method="post"  enctype="multipart/form-data">
            @csrf
            <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark"> Add Service</h3>
                </div>
                <!-- end   :: Card header -->
                ...
                <div class="px-8 py-4">
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="phone_inp" name="description" placeholder="example" value="{{ old('description') }}">
